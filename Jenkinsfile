...
pipeline {
	...
	environment {
		...
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/avr128da48-led-blink-pwm-example.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/avr128da48-led-blink-pwm-example.git'
